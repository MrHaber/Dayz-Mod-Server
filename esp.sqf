...
moptions = 
{
	...
	[
		["",true],
		["Настройки админ-панели", [-1], "", -5, [["expression", ""]], "1", "0"],
		[format["ESP игроков: %1",spi], [2], "", -5, [["expression", "spi = !spi;"]], "1", "1"],
		[format["Телепорт: %1",tpe], [3], "", -5, [["expression", "tpe = !tpe;"]], "1", "1"],
		[format["Дефолтные иконки ТС: %1",sci], [4], "", -5, [["expression", "sci = !sci;"]], "1", "1"],
		[format["Показать палатки: %1",sht], [5], "", -5, [["expression", "sht = !sht;"]], "1", "1"],
		...
		[format["Альтернативный вариант телепортации: %1",tpa], [9], "", -5, [["expression", "tpa = !tpa;"]], "1", "1"],
		[format["Обход infistar: %1",uvb], [10], "", -5, [["expression", "uvb = !uvb;"]], "1", "1"]
	];  
...
if (isnil "mapm" && (getPlayerUID player) in ADMIN_LIST) then 
{
	...
	titleText ["Markers Added! Teleporting:Open Map, hold Left ALT, left click on map.","PLAIN DOWN"];titleFadeOut 2;
